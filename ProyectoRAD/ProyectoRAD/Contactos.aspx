            ...
            <td>
                <table align="center" class="auto-style3" style="background-image: url('Images/opacity.png')">
                    ...
                    <tr>
                        ...
                        <td class="auto-style5">
                            <asp:Label ID="Label3" runat="server" CssClass="auto-style6" Text="Telefonos con extensión"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="auto-style5">
                            <asp:ListBox ID="lstTel" runat="server" Height="192px" Width="235px"></asp:ListBox>
                        </td>
                        <td class="auto-style5">
                            <asp:ListBox ID="lstExt" runat="server" Height="192px" Width="235px"></asp:ListBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="auto-style5" colspan="2">
